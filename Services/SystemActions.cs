...
namespace MenubarDock.Services
{
    public static class SystemActions
    {
        ...
        // Window Management
        public static void MinimizeWindow() => SendWin(0x28);      // Win+Down
        public static void MaximizeWindow() => SendWin(0x26);      // Win+Up
        public static void SnapWindowLeft() => SendWin(0x25);      // Win+Left
        public static void SnapWindowRight() => SendWin(0x27);     // Win+Right
        public static void CloseActiveWindow() => SendAlt(0x73);   // Alt+F4

        // Edit Actions
        public static void TriggerUndo() => SendCtrl(0x5A);        // Ctrl+Z
        public static void TriggerRedo() => SendCtrl(0x59);        // Ctrl+Y
        public static void TriggerCut() => SendCtrl(0x58);         // Ctrl+X
        public static void TriggerCopy() => SendCtrl(0x43);        // Ctrl+C
        public static void TriggerPaste() => SendCtrl(0x56);       // Ctrl+V
        public static void TriggerSelectAll() => SendCtrl(0x41);   // Ctrl+A

        // View Actions
        public static void TriggerFullscreen() => SendKey(0x7A);   // F11
        public static void TriggerZoomIn() => SendCtrl(0xBB);      // Ctrl+=
        public static void TriggerZoomOut() => SendCtrl(0xBD);     // Ctrl+-
        public static void TriggerZoomReset() => SendCtrl(0x30);   // Ctrl+0
